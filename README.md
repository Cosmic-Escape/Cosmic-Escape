...
## Deploy
Deploy to Vercel (recommended) or any container host (Dockerfile included).

## TODO
- Hook contact API to email service (SendGrid/Formspree)
- Add blog MDX (next-mdx-remote)
- Add analytics (Plausible, Vercel Analytics, or GA)
...
- **Foundations and Experiments** – early projects, learning exercises, and the sparks of creativity that shaped my path.  
- **Advanced Engineering** – large-scale systems, optimized architectures, and full-stack applications that solve real-world problems.  
- **End-to-End Pipelines** – complete workflows, from conception to deployment, demonstrating the lifecycle of complex solutions.  
- **Innovation and Exploration** – projects that push boundaries, explore emerging technologies, and embrace the unknown.  
